...
export default function SidebarAdmin() {
    ...
    return (
        <aside className="group w-20 hover:w-72 bg-slate-900 border-r border-slate-800 text-slate-400 h-screen sticky top-0 flex flex-col justify-between transition-all duration-300 ease-in-out shadow-2xl z-50 overflow-y-auto overflow-x-hidden">
                        ...
                        item.isDropdown ? (
                            <div key={idx}>
                                ...
                                >
                                    ...
                                    <span className="flex-1 text-left transition-all duration-300 whitespace-nowrap opacity-0 group-hover:opacity-100">
                                        {item.label}
                                    </span>
                                    <svg

...
class RolFuncionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $modulos = [
            ...
            ['nombre' => 'Postulantes y Requisitos','descripcion' => 'Gestión de postulantes y sus requisitos'],
        ...
        $funcionesData = [
            ...
            // Módulo: Postulantes y Requisitos
            ['nombre' => 'Ver Postulantes',          'permiso' => 'postulantes.leer',            'modulo' => 'Postulantes y Requisitos'],
